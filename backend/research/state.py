...
import os
import uuid
from typing import List, Dict, Set, Literal, Any, Optional, Union
...
class SearchParameters(BaseModel):
    ...
    country: Optional[str] = None  # ISO country code or full name
    
    # Perplexity-specific
    perplexity_domain_filter: Optional[List[str]] = None
    perplexity_language_filter: Optional[List[str]] = None
    
    # Tavily-specific
    tavily_search_depth: Optional[str] = None  # basic | fast | advanced | ultra-fast
    tavily_topic: Optional[str] = None  # general | news | finance
    tavily_time_range: Optional[str] = None  # day | week | month | year
    tavily_include_domains: Optional[List[str]] = None
    tavily_exclude_domains: Optional[List[str]] = None
...
class WorkerState(BaseModel):
    ...
    queries: List[Union[str, dict]] = Field(
...
class ResearchState(BaseModel):
    ...
    topic: str
    status: Literal["initialized", "running", "verification_pending", "completed", "failed"] = "initialized"
